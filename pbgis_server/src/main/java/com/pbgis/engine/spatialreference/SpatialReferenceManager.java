package com.pbgis.engine.spatialreference;
...
public class SpatialReferenceManager {
	...
	/**
	 * Load custom CRSs from directory. The file name of custom CRS is
	 * <wkid>.prj. The content of file is WKT. Notice: custom CRSs have higher
	 * priority
	 * 
	 * @param crsDirPath
	 * @throws Exception
	 */
	public static void loadCustomCRSs(String crsDirPath) throws Exception {
	...
	public static ArrayList<String> getInternalWkids() {
		...
		for (Iterator<String> itCode = codes.iterator();itCode.hasNext();) {
