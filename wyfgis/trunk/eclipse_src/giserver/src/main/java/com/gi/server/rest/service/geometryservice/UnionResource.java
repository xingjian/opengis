...
public class UnionResource {
	...
	private String generateJSONResult(Geometry convexHullGeometry,
			String geometries) {
		String result = null;
		...
		try {
			...
			if (geometries != null && convexHullGeometry == null) {
				ArrayList<String> details = new ArrayList<String>();
				details.add("Result is NULL.");
			} else {
				obj.put("geometryType", EsriJsonUtil
						.geometryType2String(convexHullGeometry.getClass()));
				obj.put("geometry", EsriJsonUtil
						.geometry2JSON(convexHullGeometry));
			}
	...
	private String generateHTMLResult(Geometry resultGeometry, String token,
			String geometries) {
		String result = "";
		...
		try {
			...
			sb
					.append("<tr><td colspan='2'><input type='submit' value='Union' /></td></tr>");
