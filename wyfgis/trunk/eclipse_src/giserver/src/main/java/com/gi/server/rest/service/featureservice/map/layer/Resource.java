 ...
 * 
 */
@Path("/FeatureService/{serviceName}/{layerId}")
...
public class Resource {
	...
	private String generateHTMLResult(String serviceName, int layerId,
			MapLayer mapLayer, boolean needToken, boolean editable) {
		String result = "";
		...
		try {
			...
			sb.append("&nbsp;&nbsp;<a href='" + contextRoot
					...
					+ layerId + "/query'>Query</a>");

			if (editable) {
				sb.append("&nbsp;&nbsp;<a href='" + contextRoot
						+ "/rest/service/FeatureService/" + serviceName + "/"
						+ layerId + "/addFeatures'>Add Features</a>");
				sb.append("&nbsp;&nbsp;<a href='" + contextRoot
						+ "/rest/service/FeatureService/" + serviceName + "/"
						+ layerId + "/updateFeatures'>Update Features</a>");
				sb.append("&nbsp;&nbsp;<a href='" + contextRoot
						+ "/rest/service/FeatureService/" + serviceName + "/"
						+ layerId + "/deleteFeatures'>Delete Features</a>");
				sb.append("&nbsp;&nbsp;<a href='" + contextRoot
						+ "/rest/service/FeatureService/" + serviceName + "/"
						+ layerId + "/applyEdits'>Apply Edits</a>");
			}
			sb.append("<br/><br/>");
