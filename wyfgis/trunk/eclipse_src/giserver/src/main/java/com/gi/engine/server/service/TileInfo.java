...
public class TileInfo {
	...
	private boolean readCompact = false;
	...
	public boolean isReadCompact() {
		return readCompact;
	}

	public void setReadCompact(boolean readCompact) {
		this.readCompact = readCompact;
	}
}