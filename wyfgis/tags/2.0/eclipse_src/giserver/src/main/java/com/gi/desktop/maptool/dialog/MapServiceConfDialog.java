...
public class MapServiceConfDialog extends javax.swing.JDialog {
	...
	private JButton getJButtonBrowse() {
		if (jButtonBrowseOutput == null) {
			...
			jButtonBrowseOutput.setBounds(302, 332, 69, 29);
	...
	private JButton getJButtonBrowseTile() {
		if (jButtonBrowseTile == null) {
			...
			jButtonBrowseTile.setBounds(313, 46, 69, 29);
		}
	...
	private JCheckBox getJCheckBoxCreateOnDemand() {
		if (jCheckBoxCreateOnDemand == null) {
			...
			jCheckBoxCreateOnDemand.setBounds(12, 87, 166, 26);
	...
	private JLabel getJLabel13() {
		if (jLabel13 == null) {
			...
			jLabel13.setBounds(12, 248, 49, 22);
		}
		return jLabel13;
	}
	...
	private JLabel getJLabel8() {
		if (jLabel8 == null) {
			...
			jLabel8.setBounds(12, 12, 111, 22);
		}
		return jLabel8;
	}
	...
	private JTextField getJTextFieldTileDir() {
		if (jTextFieldTileDir == null) {
			...
			jTextFieldTileDir.setBounds(12, 46, 295, 29);
		}
					...
					getContentPane().add(jPanel2);
					{
						...
						}
						{
									...
									388, 445));
							{
								...
								jLabel1.setBounds(12, 12, 121, 22);
							}
							{
							...
							}
							{
								...
								jCheckBoxAutoStart.setBounds(12, 56, 96, 26);
							...
							}
							{
								...
								jCheckBoxNeedToken.setBounds(191, 56, 111, 25);
							}
							{
								jLabel2 = new JLabel();
								jPanel4.add(jLabel2);
								jLabel2.setText("Instance Number: ");
								jLabel2.setBounds(12, 105, 142, 22);
							}
							{
							...
							}
							{
								...
								jLabel4.setBounds(12, 158, 140, 22);
							}
							{
							...
							}
							{
								...
								jPanel4.add(jLabel5);
								jLabel5.setText("DPI: ");
								jLabel5.setBounds(12, 255, 36, 22);
							}
							{
							...
							}
							{
								...
								jLabel6.setBounds(12, 206, 156, 22);
							}
							{
